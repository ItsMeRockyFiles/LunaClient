 ...
 * Roblox Version: version-8bb29a9b986b4cfa
 * Time Taken: 4078 ms (4.078000 seconds)
 * Total Offsets: 326
 */
...
// clang-format off
namespace offsets {
    inline constexpr const char* roblox_version = "version-8bb29a9b986b4cfa";
    ...
    namespace ByteCode {
        ...
        inline constexpr uintptr_t Size = 0x84;
    }
    ...
    namespace Fire {
        inline constexpr uintptr_t FireProximityPrompt = 0x31407D0;
    }
    ...
    namespace Functions {
        inline constexpr uintptr_t Clone = 0x1651A90; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t Destroy = 0x1651AB0; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t FindPartOnRay = 0xED6790; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t FindPartOnRayWithIgnoreList = 0xED6810; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t FindPartOnRayWithWhitelist = 0xED68A0; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t FireServer = 0xCB2C10; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t Print = 0x1CD9D80;
        inline constexpr uintptr_t RaisePropertyChanged = 0xF84330;
        inline constexpr uintptr_t Raycast = 0xECDDD0; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t SetParent = 0xEC833C;
        inline constexpr uintptr_t SetParentInternal = 0x1D21ED0;
        inline constexpr uintptr_t Shapecast = 0xECF790; // better to resolve at runtime via func descriptors
    }
    ...
    namespace ModuleScript {
        inline constexpr uintptr_t Bytecode = 0x28;
    ...
    namespace TextButton {
        ...
        inline constexpr uintptr_t TextSize = 0xFEC;
